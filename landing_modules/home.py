...
def home():
    ...
    try:
        hero_image = Image.open(r".\images\hero.jpg")  # Replace with path to your banner image.
    ...
    try:
        workflow_image = Image.open(r".\images\workflow_diagram.png")  # Replace with a workflow diagram image.
